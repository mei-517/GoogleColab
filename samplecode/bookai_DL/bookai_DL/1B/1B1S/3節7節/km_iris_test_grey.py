...
plt.scatter(iris_train[:,0],iris_train[:,1], c=result.labels_, cmap='Greys', edgecolors='k')
plt.scatter(iris_test[:,0], iris_test[:,1], c=result_test, cmap='Greys', edgecolors='k', marker='D')
plt.show()
